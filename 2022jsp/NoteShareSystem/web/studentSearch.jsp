...
<%
    ...
    List dataList = dob.getData("note", field, condition);
...
<table width="551" border="0" cellpadding="0" cellspacing="1" bgcolor="#999999">
    ...
    <tr>
        ...
        <td bgcolor="#FFFFFF"><a href="studentDetail.jsp?note_id=<%=ss[0]%>" target=_blank>查看</a>/<a
                href="studentModify.jsp?note_id=<%=ss[0]%>">修改</a>/<a href="delete.studentDo?note_id=<%=ss[0] %>">删除</a></td>
    </tr>
    <% } %>
</table>
...
<a href="adminSearch.jsp?page=<%=pageNum+1>totalPage ? totalPage : pageNum+1%>">下一页</a>
</body>
</html>